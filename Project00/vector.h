...
/** @brief Gets the x value associated with vec
 *
 *  @param vec the vector we want the x value from
 *  @return double
 */
double get_x(vector_t *vec);

/** @brief Gets the y value associated with vec
 *
 *  @param vec the vector we want the y value from
 *  @return double
 */
